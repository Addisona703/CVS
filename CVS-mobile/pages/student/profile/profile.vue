<template>
  <view class="profile-page">
    ...
    <view class="avatar-section">
      ...
      <text class="username">{{ userInfo.username || 'student001' }}</text>
    </view>
    ...
    <!-- Custom Tab Bar -->
    <custom-tabbar :current="3" role="student" />
  </view>
</template>
...
const userInitial = computed(() => {
  if (!userInfo.value) return '学'
  const name = userInfo.value.name || userInfo.value.username || '学'
