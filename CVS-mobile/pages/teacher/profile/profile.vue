<template>
    <view class="profile-page">
        ...
        <view class="avatar-section">
            ...
            <text class="username">{{ userInfo.username || 'teacher001' }}</text>
        </view>
        ...
        <!-- Custom Tab Bar -->
        <custom-tabbar :current="3" role="teacher" />
    </view>
</template>
...
const userInitial = computed(() => {
    if (!userInfo.value) return '教'
    const name = userInfo.value.name || userInfo.value.username || '教'
