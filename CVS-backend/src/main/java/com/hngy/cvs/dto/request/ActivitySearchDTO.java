...
public class ActivitySearchDTO {
    ...
    @Schema(description = "创建者名字关键词", example = "张老师")
    ...
    @Schema(description = "开始时间范围-开始", example = "2024-03-01T00:00:00")
    private LocalDateTime startTimeFrom;

    @Schema(description = "开始时间范围-结束", example = "2024-03-31T23:59:59")
